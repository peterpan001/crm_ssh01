					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>客户级别 ：</td>
								<td>
									<select id="levelId" name="level.dict_id" style="WIDTH: 180px" maxLength="50"></select>
								</td>
							</TR>
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select id="sourceId" name="source.dict_id" style="WIDTH:180px" maxLength="50"></select>
								</td>
								<td>联系人：</td>
								<td>
							...
							<TR>
								<td>客户行业 ：</td>
								<td>
									<select id="industryId" name="industry.dict_id" style="WIDTH:180px" maxLength="50"></select>
								</td>
								<td>文件上传 ：</td>
								<td>
